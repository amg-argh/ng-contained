...
/// <reference path="Plugins/Waypoint.ts" />

/// <reference path="ScollerHandlers/IScrollerHandler.ts" />
/// <reference path="ScollerHandlers/ScrollbarClickScrollHandler.ts" />
...
/// <reference path="ScrollbarFactory.ts" />
/// <reference path="OffsetFactory.ts" />
